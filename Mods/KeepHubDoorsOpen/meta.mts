...
[hr][/hr]
Normally when a hub is attacked, doors slam shut and lock you out (or in). This mod disables the door-closing signals across all hubs that use them: Concrete Plant, DK Energetic, Himzavod, IKAR Camp, Noon Base, Rookie Village, Rostok, Terricon, and Yanov.
...
keepHubDoorsOpenTransformer.files = [
  ...
  "/QuestNodePrototypes/Rostok_Radio.cfg",
];
