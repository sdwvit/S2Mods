...
export const meta: MetaType<LootingNpcPrototype> = {
  ...
  changenote:
    "Updated for 2.0: patches regenerated against 2.0 game data. Patch all current ObjPrototypes entries with CanProcessCorpses and keep NPCBase disabled as a fallback.",
