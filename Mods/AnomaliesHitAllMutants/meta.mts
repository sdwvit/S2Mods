...
This mod sets ShouldTriggerAnomalies to true for every base-game mutant (even new ones from 2.0), so anomalies affect them just like they affect smaller creatures.[h1][/h1]
DLC mutants are left untouched.[h1][/h1]
 
[hr][/hr]If you enjoy my mods and would like to support me, you can donate here: [url=https://donate.stripe.com/3cIbJ21Ld7u4clXfyb5Rm03]donate[/url]. Feel free to mention which mod you're donating for — it helps me understand what you're interested in.
`,
  changenote: "Excluded DLC mutants — only base-game mutants now trigger anomalies.",
...
transformMutants.dlc = false;
transformMutants.files = ["ObjPrototypes"];
transformMutants.contains = true;
