...
import type { QuestDataTableEntry } from "./questData.mts";
import { QuestDataTableByQuestSID, recurringQuestsFilenames } from "./questData.mts";
...
function replaceRewards(
  struct: QuestNodePrototypeSetItemGenerator,
  fork: QuestNodePrototypeSetItemGenerator,
) {
