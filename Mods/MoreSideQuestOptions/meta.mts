...
`,
  changenote: "Independent quest system: all RSQ sub-quests available via hub dialog, with per-quest cancel",
  structTransformers: [transformDialogPrototypes, transformGlobalVariablePrototypes, transformQuestNodePrototypes, transformQuestPrototypes],
};
